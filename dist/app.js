(() => {
  ...
  __commonjs = {
    26() {
      ...
      function vectorLineDistance2(vector3, line5) {
        let l2 = new index2.Line(vector3, new index2.Vector2(-line5.vector.y, line5.vector.x));
      ...
      function drawPoint(stage2, point7) {
        const radius = 5;
        const x = point7.geom.x;
        const y = point7.geom.y;
